...
while flag1 == True:
    ...
    if menu == "1":
        ...
        print(f"Cool {name},  get ready to play.")
        ...
        while True:
            ...
            if player_choice not in choices:
                print(f"Invalid input, the word {player_choice} is incorrect. Try again. ")
                continue

            computer_choice = random.choice(choices)

            print(f"{name} chooses:", player_choice)
        ...
        while flag2 == True:
            ...
            if highscore == "1":
                ...
                list1 = input("Return to main menu with (m) or return to high score lists by pressing any key")
                if list1 == "m":
                    flag2 = False

            elif highscore == "2":
                print("List of players sorted with most games")
                list2 = input("Return to main menu with (m) or return to high score lists by pressing any key")
                if list2 == "m":
                    flag2 = False

            elif highscore == "3":
                print("List of players sorted with most draws")
                list3 = input("Return to main menu with (m) or return to high score lists by pressing any key")
                if list3 == "m":
                    flag2 = False

            elif highscore == "4":
                print("List of players sorted with most loses")
                list4 = input("Return to main menu with (m) or return to high score lists by pressing any key")
                if list4 == "m":
                    flag2 = False
