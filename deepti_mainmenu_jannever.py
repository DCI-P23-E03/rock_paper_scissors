...
while True:
    ...
    if option == "1":
        ...
        for player_name in player_list:
            ...
            print(f"\nYour statistics from this session:   \n", 
...
You have achieved {player_profile['Total_Wins']} amazing wins against your opponent. With\
 your cunning you have been able to reach draw {player_profile['Total_Draw']} gruelling times. \
With all your might, you have still tasted the bitter taste of defeat {player_profile['Total_Loses']} times.")
